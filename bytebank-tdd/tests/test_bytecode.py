...
class TestFuncionario:
    ...
    def test_decrescimo_de_salario(self):
        milla = Funcionario("Milla Valeriano", "14/09/1989", 30000)

        milla_salario_inicial = milla.salario

        assert milla_salario_inicial == 30000

        milla.decrescimo_salario

        milla_salario_final = milla.salario
